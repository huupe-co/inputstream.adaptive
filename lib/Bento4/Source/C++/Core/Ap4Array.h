...
public:
  ...
  AP4_Array& operator=(const AP4_Array<T>& copy);
  virtual ~AP4_Array();
...
AP4_Array<T>::AP4_Array(const T* items, AP4_Size count)
  : m_AllocatedCount(count), m_ItemCount(count), m_Items((T*)::operator new(count * sizeof(T)))
{
...
+---------------------------------------------------------------------*/
template<typename T>
inline AP4_Array<T>::AP4_Array(const AP4_Array<T>& copy)
  : m_AllocatedCount(0), m_ItemCount(0), m_Items(0)
{
...
+---------------------------------------------------------------------*/
template<typename T>
AP4_Array<T>& AP4_Array<T>::operator=(const AP4_Array<T>& copy)
{
...
+---------------------------------------------------------------------*/
template<typename T>
AP4_Result AP4_Array<T>::SetItemCount(AP4_Cardinal item_count)
{
  // shortcut
...
+---------------------------------------------------------------------*/
template<typename T>
AP4_Result AP4_Array<T>::RemoveLast()
{
  if (m_ItemCount)
  {
...
AP4_Result AP4_Array<T>::Append(const T& item)
{
  ...
  if (m_AllocatedCount < m_ItemCount + 1)
  {
    ...
    if (new_count < m_ItemCount + 1)
      new_count = m_ItemCount + 1;
